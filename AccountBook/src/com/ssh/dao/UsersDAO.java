...
public class UsersDAO {
	...
	public Users findById(java.lang.String id) {
		...
		try {
			Users instance = (Users) getCurrentSession().get("com.ssh.entity.Users", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Users instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.ssh.entity.Users").add(Example.create(instance))
					.list();
